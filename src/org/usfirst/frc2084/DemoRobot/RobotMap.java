...
public class RobotMap {
    ...
    public static Servo clawSubsystemLiftServo;
    public static Servo clawSubsystemClawServo;
    ...
    public static void init() {
        ...
        clawSubsystemLiftServo = new Servo(1, 3);
        LiveWindow.addActuator("Claw Subsystem", "Lift Servo", clawSubsystemLiftServo);

        clawSubsystemClawServo = new Servo(1, 4);
        LiveWindow.addActuator("Claw Subsystem", "Claw Servo", clawSubsystemClawServo);
