...
public class RobotMap {
    ...
    public static Solenoid shooterSubsystemLoaderSolenoid;
    public static SpeedController shooterSubsystemWheelVictor;
	...
	LiveWindow.addActuator("Drive Subsystem", "Right Jaguar", (Jaguar) driveSubsystemRightJaguar);
        ...
        shooterSubsystemLoaderSolenoid = new Solenoid(1, 1);
	LiveWindow.addActuator("Shooter Subsystem", "Loader Solenoid", shooterSubsystemLoaderSolenoid);
        
        shooterSubsystemWheelVictor = new Victor(1, 10);
	LiveWindow.addActuator("Shooter Subsystem", "Wheel Victor", (Victor) shooterSubsystemWheelVictor);
